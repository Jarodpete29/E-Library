...
<div class="container5 container mt-5">
    ...
    <nav class="navbar ">
            ...
            <a href="archive.php" id="bb" class="btn btn-danger ">TRASH</a>
    </form>      
</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <?php
                          $query = "SELECT * FROM books WHERE archive=1 ORDER BY ID Desc";
                          if(isset($_GET['query'])){
                              ...
                              <tr>
                                ...
                                <td class="btn-cont">
                                  ...
                                  <form action="create.php"  method="POST" class="d-inline">
                                    <button type ="submit" id="del" name="delete" value="<?=$books['ID'];?>" class="btn1 btn-danger btn-sm">Delete</a>
                                  </form>
